#ifndef M_IO_BYTE_BVEC4_H
#define M_IO_BYTE_BVEC4_H
 ...
 */
O_INLINE
osize bvec4_buffer(char *str, osize size, m_bvec4 bvec, bool colored, bool typed)
{
    return bvecn_buffer(str, size, bvec.v, 4, colored, typed);
}
 ...
 */
O_INLINE
char *bvec4_str(oobj parent, m_bvec4 bvec, bool colored, bool typed)
{
    return bvecn_str(parent, bvec.v, 4, colored, typed);
}
...
/**
 * Calls bvec4_buffer and prints to stdout with colors (typed)
 * In the style:
 ...
 */
O_INLINE
osize bvec4_print(m_bvec4 bvec)
{
    return bvecn_print(bvec.v, 4);
}
 ...
 */
O_INLINE
osize bvec4_println(m_bvec4 bvec)
{
    return bvecn_println(bvec.v, 4);
}
 ...
 */
O_INLINE
bool bvec4_json_read(m_bvec4 *out_bvec, oobj json_array)
{
    return bvecn_json_read(out_bvec->v, 4, json_array);
}
 ...
 */
O_INLINE
oobj bvec4_json_new(oobj parent, const char *name, m_bvec4 bvec)
{
    return bvecn_json_new(parent, name, bvec.v, 4);
}


#endif //M_IO_BYTE_BVEC4_H
