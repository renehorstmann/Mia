#ifndef M_IO_FLT_VEC3_H
#define M_IO_FLT_VEC3_H
 ...
 */
O_INLINE
osize vec3_buffer(char *str, osize size, m_vec3 vec, bool colored, bool typed)
{
    return vecn_buffer(str, size, vec.v, 3, colored, typed);
}
 ...
 */
O_INLINE
char *vec3_str(oobj parent, m_vec3 vec, bool colored, bool typed)
{
    return vecn_str(parent, vec.v, 3, colored, typed);
}
...
/**
 * Calls vec3_buffer and prints to stdout with colors (typed)
 * In the style:
 ...
 */
O_INLINE
osize vec3_print(m_vec3 vec)
{
    return vecn_print(vec.v, 3);
}
 ...
 */
O_INLINE
osize vec3_println(m_vec3 vec)
{
    return vecn_println(vec.v, 3);
}
 ...
 */
O_INLINE
bool vec3_json_read(m_vec3 *out_vec, oobj json_array)
{
    return vecn_json_read(out_vec->v, 3, json_array);
}
 ...
 */
O_INLINE
oobj vec3_json_new(oobj parent, const char *name, m_vec3 vec)
{
    return vecn_json_new(parent, name, vec.v, 3);
}


#endif //M_IO_FLT_VEC3_H
